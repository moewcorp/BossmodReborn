...
public enum PacketID
{
    ...
    StatusEffectList = 208,
    StatusEffectListEureka = 209,
    StatusEffectListBozja = 210,
    StatusEffectListForay3 = 211,
    StatusEffectListDouble = 212,
    EffectResult1 = 214,
    EffectResult4 = 215,
    EffectResult8 = 216,
    EffectResult16 = 217,
    EffectResultBasic1 = 219,
    EffectResultBasic4 = 220,
    EffectResultBasic8 = 221,
    EffectResultBasic16 = 222,
    EffectResultBasic32 = 223,
    EffectResultBasic64 = 224,
    ActorControl = 225,
    ActorControlSelf = 226,
    ActorControlTarget = 227,
    UpdateHpMpTp = 228,
    ActionEffect1 = 229,
    ActionEffect8 = 232,
    ActionEffect16 = 233,
    ActionEffect24 = 234,
    ActionEffect32 = 235,
    StatusEffectListPlayer = 238,
    StatusEffectListPlayerDouble = 239,
    UpdateRecastTimes = 241,
    UpdateDutyRecastTimes = 242,
    UpdateDutyRecastTimes5 = 243,
    UpdateAllianceNormal = 244,
    UpdateAllianceSmall = 245,
    UpdatePartyMemberPositions = 246,
    UpdateAllianceNormalMemberPositions = 247,
    UpdateAllianceSmallMemberPositions = 248,
    GCAffiliation = 251,
    SpawnPlayer = 269,
    SpawnNPC = 270,
    SpawnBoss = 271,
    DespawnCharacter = 272,
    ActorMove = 273,
    Transfer = 275,
    ActorSetPos = 276,
    ActorCast = 279,
    PlayerUpdateLook = 280,
    UpdateParty = 281,
    InitZone = 282,
    ApplyIDScramble = 283,
    UpdateHate = 284,
    ...
    DespawnObject = 287,
    UpdateClassInfo = 288,
    UpdateClassInfoEureka = 289,
    UpdateClassInfoBozja = 290,
    UpdateClassInfoForay3 = 291,
    PlayerSetup = 292,
    PlayerStats = 293,
    FirstAttack = 294,
    PlayerStateFlags = 295,
    PlayerClassInfo = 296,
    PlayerBlueMageActions = 297,
    ModelEquip = 298,
    Examine = 299,
    CharaNameReq = 302,
    RetainerSummary = 306,
    RetainerInformation = 307,
    ItemMarketBoardSummary = 308,
    ItemMarketBoardInfo = 309,
    ItemInfo = 311,
    ContainerInfo = 312,
    InventoryTransactionFinish = 313,
    InventoryTransaction = 314,
    CurrencyCrystalInfo = 315,
    InventoryActionAck = 317,
    UpdateInventorySlot = 318,
    OpenTreasure = 320,
    LootMessage = 323,
    CreateTreasure = 327,
    TreasureFadeOut = 328,
    ...
    QuestActiveList = 360,
    QuestUpdate = 361,
    QuestCompleteList = 362,
    QuestFinish = 363,
    MSQTrackerComplete = 366,
    QuestTracker = 368,
    Mount = 369,
    DirectorVars = 371,
    ContentDirectorSync = 372,
    ServerRequestCallbackResponse1 = 380,
    ServerRequestCallbackResponse2 = 381,
    ServerRequestCallbackResponse3 = 382,
    MapEffect1 = 404,
    MapEffect2 = 405,
    MapEffect3 = 406,
    MapEffect4 = 407,
    MapEffect5 = 408,
    MapEffect6 = 409,
    SystemLogMessage1 = 412,
    SystemLogMessage2 = 413,
    SystemLogMessage4 = 414,
    SystemLogMessage8 = 415,
    SystemLogMessage16 = 416,
    BattleTalk2 = 418,
    BattleTalk4 = 419,
    BattleTalk8 = 420,
    MapUpdate = 422,
    ...
    PlayerTitleList = 435,
    Discovery = 436,
    EorzeaTimeOffset = 438,
    EquipDisplayFlags = 451,
    NpcYell = 452,
    FateInfo = 457,
    CompletedAchievements = 462,
    LandSetInitialize = 471,
    LandUpdate = 472,
    YardObjectSpawn = 473,
    HousingIndoorInitialize = 474,
    LandAvailability = 475,
    LandPriceUpdate = 477,
    LandInfoSign = 478,
    LandRename = 479,
    HousingEstateGreeting = 480,
    HousingUpdateLandFlagsSlot = 481,
    HousingLandFlags = 482,
    HousingShowEstateGuestAccess = 483,
    HousingObjectInitialize = 485,
    HousingInternalObjectSpawn = 486,
    HousingWardInfo = 488,
    HousingObjectMove = 489,
    HousingObjectDye = 490,
    SharedEstateSettingsResponse = 502,
    DailyQuests = 514,
    DailyQuestRepeatFlags = 516,
    LandUpdateHouseName = 518,
    AirshipTimers = 529,
    PlaceMarker = 537,
    WaymarkPreset = 538,
    Waymark = 539,
    UnMount = 542,
    CeremonySetActorAppearance = 545,
    AirshipStatusList = 551,
    AirshipStatus = 552,
    AirshipExplorationResult = 553,
    SubmarineStatusList = 554,
    ...
    PlayMotionSync = 641,
    CEDirector = 650,
    IslandWorkshopDemandResearch = 669,
    IslandWorkshopSupplyDemand = 672,
    IslandWorkshopFavors = 688,
}
