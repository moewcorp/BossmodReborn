namespace BossMod.Modules.Dawntrail.Raid.M09NVampFatale
{
    ...
    {
        AutoAttack = 48038, // VampFatale->player, no cast, single-target
        KillerVoice = 45921, // VampFatale->self, 5.0s cast, range 60 circle
        HalfMoon = 48825, // VampFatale->self, 4.3+0.7s cast, single-target
        HalfMoon1 = 45910, // Helper->self, 5.0s cast, range 60 180.000-degree cone
        HalfMoon2 = 45911, // Helper->self, 8.5s cast, range 60 180.000-degree cone
        ...
        AutoAttack1 = 47047, // VampFatale->player, no cast, single-target
        ...
        HalfMoon3 = 48826, // VampFatale->self, 4.3+0.7s cast, single-target
        HalfMoon4 = 45912, // Helper->self, 5.0s cast, range 64 180.000-degree cone
        HalfMoon5 = 45913, // Helper->self, 8.5s cast, range 64 180.000-degree cone
        ...
        HalfMoon6 = 48824, // VampFatale->self, 4.3+0.7s cast, single-target
        HalfMoon7 = 45908, // Helper->self, 5.0s cast, range 64 180.000-degree cone
        HalfMoon8 = 45909, // Helper->self, 8.5s cast, range 64 180.000-degree cone
