...
sealed class RideTheWaves(BossModule module) : Components.GenericAOEs(module)
{
    ...
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        ...
        hints.AddForbiddenZone(new SDInvertedRect(new WPos(82.5f + index * 5f, 80f), dir, 5f, default, 2.5f), _aoes[actindex].Activation.AddSeconds(1d)); // add 1s so it doesn't get merged with other aoes
    }
}
