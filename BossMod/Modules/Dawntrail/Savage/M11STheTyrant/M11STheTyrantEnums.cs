...
public enum AID : uint
{
    ...
    ArcadionAvalanche_Pick1 = 46154, // Boss->self, 6.0+9.5s cast, single-target ; NE safe slice, East safe West danger
    ArcadionAvalanche_Smash1 = 46155, // Helper->self, 15.5s cast, range 40 width 40 rect ; NE safe slice, East safe West danger
    ArcadionAvalanche_Pick2 = 46156, // Boss->self, 6.0+9.5s cast, single-target ; SE safe slice, East safe West danger
    ArcadionAvalanche_Smash2 = 46157, // Helper->self, 15.5s cast, range 40 width 40 rect ; SE safe slice, East safe West danger
    ArcadionAvalanche_Pick3 = 46158, // Boss->self, 6.0+9.5s cast, single-target ; SW safe slice, West safe East danger
    ArcadionAvalanche_Smash3 = 46159, // Helper->self, 15.5s cast, range 40 width 40 rect ; SW safe slice, West safe East danger
    ArcadionAvalanche_Pick4 = 46160, // Boss->self, 6.0+9.5s cast, single-target ; NW safe slice, West safe East danger
    ArcadionAvalanche_Smash4 = 46161, // Helper->self, 15.5s cast, range 40 width 40 rect ; NW safe slice, West safe East danger
