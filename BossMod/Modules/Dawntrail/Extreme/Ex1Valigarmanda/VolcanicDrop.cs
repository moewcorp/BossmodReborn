...
sealed class VolcanicDrop(BossModule module) : Components.GenericAOEs(module, (uint)AID.VolcanicDropAOE)
{
    ...
    public override void OnMapEffect(byte index, uint state)
    {
        ...
        {
            var pos = (Arena.Center + new WDir(index == 0x0E ? 13f : -13f, default)).Quantized();
            AOE = [new(circle, pos, default, WorldState.FutureTime(7.8d), shapeDistance: circle.Distance(pos, default))];
        }
    }
}
