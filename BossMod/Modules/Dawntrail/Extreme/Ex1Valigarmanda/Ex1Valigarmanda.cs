...
sealed class IceTalon(BossModule module) : Components.BaitAwayIcon(module, 6f, (uint)IconID.IceTalon, (uint)AID.IceTalonAOE, 5.1d, tankbuster: true, damageType: AIHints.PredictedDamageType.Tankbuster);
...
[ModuleInfo(BossModuleInfo.Maturity.Verified, Contributors = "Malediktus", GroupType = BossModuleInfo.GroupType.CFC, GroupID = 833u, NameID = 12854u, PlanLevel = 100)]
public sealed class Ex1Valigarmanda(WorldState ws, Actor primary) : BossModule(ws, primary, new(100f, 100f), new ArenaBoundsRect(20f, 15f))
{
