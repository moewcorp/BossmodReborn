...
{
    private static readonly ArenaBoundsCustom arena = new([new Circle(new(-2.7f, -217), 21.5f), new Rectangle(new(-0.9f, -237.7f), 5, 1, -5.Degrees())], [new Rectangle(new(-3, -195), 20, 1.25f)]);
}
