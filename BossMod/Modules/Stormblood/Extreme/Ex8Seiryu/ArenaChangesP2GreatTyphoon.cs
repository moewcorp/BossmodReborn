...
sealed class GreatTyphoonCone(BossModule module) : Components.SimpleAOEs(module, (uint)AID.GreatTyphoonCone, new AOEShapeDonutSector(20f, 45f, 15f.Degrees()), arenaProjectionLayers: [0f], restrictToArenaProjectionLayer: true);
...
sealed class GreatTyphoonDonut(BossModule module) : Components.GenericAOEs(module)
{
    ...
    public override void OnCastStarted(Actor caster, ActorCastInfo spell)
    {
        ...
        if (shape != null)
        {
            _aoe = [new(shape, spell.LocXZ, default, Module.CastFinishAt(spell), actorID: caster.InstanceID, arenaProjectionLayer: 0, restrictToArenaProjectionLayer: true)];
        }
    }
