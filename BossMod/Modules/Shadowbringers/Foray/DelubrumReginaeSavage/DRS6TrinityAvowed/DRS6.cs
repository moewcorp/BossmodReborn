...
class WrathOfBozjaBow(BossModule module) : Components.CastSharedTankbuster(module, (uint)AID.WrathOfBozjaBow, new AOEShapeCone(60f, 45f.Degrees()));
...
public class DRS6TrinityAvowed(WorldState ws, Actor primary) : TrinityAvowed(ws, primary);
