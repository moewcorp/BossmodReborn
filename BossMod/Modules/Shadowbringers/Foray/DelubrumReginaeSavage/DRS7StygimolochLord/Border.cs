...
sealed class Border(BossModule module) : Components.GenericAOEs(module)
{
    ...
    private static readonly Shape[] labyrinthDifference = [new DonutV(ArenaCenter, 30f, 34.6f, 48), new DonutV(ArenaCenter, 17f, 25f, 48), new Polygon(ArenaCenter, 12f, 48)];
