...
public sealed class CLL4Dawon(WorldState ws, Actor primary) : BossModule(ws, primary, DawonStartingArena.Center, DawonStartingArena)
{
    ...
    public static readonly ArenaBoundsCustom LyonStartingArena = new([new Polygon(LyonCenter, 24.5f, 48)]) { Y = 258.7f, BorderY = 258.7f };
    public static readonly ArenaBoundsCustom LyonDefaultArena = new([new Polygon(LyonCenter, 20f, 48)]) { Y = 258.7f, BorderY = 258.7f };
    public static readonly WPos DawonCenter = new(80f, -813f);
    public static readonly ArenaBoundsCustom DawonStartingArena = new([new Polygon(DawonCenter, 34.5f, 96)], [new Rectangle(new(80f, -778f), 20f, 1.25f)]) { Y = 254.5f, BorderY = 254.5f };
    public static readonly ArenaBoundsCustom DawonDefaultArena = new([new Polygon(DawonCenter, 30f, 96)]) { Y = 254.5f, BorderY = 254.5f };
