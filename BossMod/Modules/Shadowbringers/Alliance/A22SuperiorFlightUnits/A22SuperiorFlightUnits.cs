...
sealed class PrecisionGuidedMissile(BossModule module) : Components.BaitAwayCast(module, (uint)AID.PrecisionGuidedMissile, 6f, tankbuster: true);
sealed class ManeuverHighPoweredLaser(BossModule module) : Components.LineStack(module, aidMarker: (uint)AID.ManeuverHighPoweredLaserMarker, (uint)AID.ManeuverHighPoweredLaser, 5.3d, 80f, 7f, 8, 8, markerIsFinalTarget: true);
...
{
    public static readonly ArenaBoundsComplex ArenaShape = new([new PolygonCustomO([new(-210.188f, -141.012f), new(-209.278f, -141.081f), new(-207.235f, -141.234f),
