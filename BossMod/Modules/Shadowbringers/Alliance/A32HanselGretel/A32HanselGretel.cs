...
class CripplingBlow1(BossModule module) : Components.SingleTargetDelayableCast(module, (uint)AID.CripplingBlow1);
class CripplingBlow2(BossModule module) : Components.SingleTargetDelayableCast(module, (uint)AID.CripplingBlow2);
...
[ModuleInfo(BossModuleInfo.Maturity.Verified, Contributors = "The Combat Reborn Team (Malediktus, LTS)", PrimaryActorOID = (uint)OID.Gretel, GroupType = BossModuleInfo.GroupType.CFC, GroupID = 779, NameID = 9990)]
