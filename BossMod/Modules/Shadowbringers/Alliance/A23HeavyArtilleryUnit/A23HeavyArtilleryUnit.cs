...
sealed class ManeuverHighPoweredLaser(BossModule module) : Components.BaitAwayIcon(module, new AOEShapeRect(60f, 4f), (uint)IconID.ManeuverHighPoweredLaser, (uint)AID.ManeuverHighPoweredLaser, 5.4d, tankbuster: true);
