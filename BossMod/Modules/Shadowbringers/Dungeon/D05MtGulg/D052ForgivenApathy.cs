...
public class D052ForgivenApathy(WorldState ws, Actor primary) : BossModule(ws, primary, primary.PosRot.Z > -106f ? arena2.Center : arena1.Center, primary.PosRot.Z > -106f ? arena2 : arena1)
{
