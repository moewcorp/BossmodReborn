...
{
    private static readonly ArenaBoundsCustom arena = new([new Polygon(new(208f, 275f), 19.5f, 48)], [new Rectangle(new(208f, 255.45f), 20f, 1f), new Rectangle(new(208.089f, 294.664f), 20f, 1.25f, -1.92f.Degrees())]);
}
