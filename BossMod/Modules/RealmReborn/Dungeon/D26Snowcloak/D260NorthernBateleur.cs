...
sealed class WallRemoval(BossModule module) : BossComponent(module)
{
    public override void OnActorEAnim(Actor actor, uint state)
    {
        ...
        {
            var arena = D260NorthernBateleur.BuildArena2();
...
[ModuleInfo(BossModuleInfo.Maturity.Verified, Contributors = "The Combat Reborn Team (Malediktus)", GroupType = BossModuleInfo.GroupType.CFC, GroupID = 27u, NameID = 3220u, SortOrder = 2)]
public sealed class D260NorthernBateleur : BossModule
{
    public D260NorthernBateleur(WorldState ws, Actor primary) : this(ws, primary, BuildArena1()) { }

    private D260NorthernBateleur(WorldState ws, Actor primary, (WPos center, ArenaBoundsCustom arena) a) : base(ws, primary, a.center, a.arena) { }

    private static (WPos center, ArenaBoundsCustom arena) BuildArena1()
    {
        WPos[] vertices1 = [new(-31.24f, -185.2f), new(-30.26f, -184.84f), new(-29.79f, -184.64f), new(-29.32f, -184.42f), new(-28.88f, -184.17f),
        ...
        var arena = new ArenaBoundsCustom([new PolygonCustom(vertices1)]);
        return (arena.Center, arena);
    }

    public static (WPos center, ArenaBoundsCustom arena) BuildArena2()
    {
        WPos[] vertices1 = [new(-46.63f, -157.97f), new(-46.09f, -157.85f), new(-45.05f, -157.56f), new(-44.54f, -157.39f), new(-40.51f, -155.73f),
