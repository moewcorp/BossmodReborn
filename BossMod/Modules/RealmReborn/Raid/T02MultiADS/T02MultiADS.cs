...
{
    protected override bool CheckPull() => base.CheckPull() && !Enemies((uint)OID.ADS).Any(e => e.InCombat); // don't start modules for temporary node actors spawned during main boss fight
}
