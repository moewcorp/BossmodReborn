...
sealed class Exhaust(BossModule module) : Components.SimpleAOEs(module, (uint)AID.Exhaust, new AOEShapeRect(33f, 6f));
...
sealed class ClockworkReservoir(BossModule module) : Components.Voidzone(module, 3f, GetVoidzones)
{
...
sealed class D080EmeraldControlUnitStates : StateMachineBuilder
{
...
[ModuleInfo(BossModuleInfo.Maturity.Verified, Contributors = "The Combat Reborn Team (Malediktus)", GroupType = BossModuleInfo.GroupType.CFC, GroupID = 35u, NameID = 6924u, SortOrder = 7)]
public sealed class D080EmeraldControlUnit : BossModule
{
    public D080EmeraldControlUnit(WorldState ws, Actor primary) : this(ws, primary, BuildArena()) { }

    private D080EmeraldControlUnit(WorldState ws, Actor primary, (WPos center, ArenaBoundsCustom arena) a) : base(ws, primary, a.center, a.arena) { }

    private static (WPos center, ArenaBoundsCustom arena) BuildArena()
    {
        PolygonCustom[] poly = [new PolygonCustom([new(92.74f, -479.98f), new(99.71f, -478.71f), new(126.55f, -470.17f), new(126.99f, -469.63f), new(129.46f, -465.74f),
