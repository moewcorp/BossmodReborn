...
[ModuleInfo(BossModuleInfo.Maturity.Verified, Contributors = "The Combat Reborn Team (Malediktus)", GroupType = BossModuleInfo.GroupType.CFC, GroupID = 38u, NameID = 3838u, SortOrder = 9)]
public sealed class D060CulturedShabti : BossModule
{
    public D060CulturedShabti(WorldState ws, Actor primary) : this(ws, primary, primary.PosRot.Z > 200f ? BuildArena() : D060ClonedConjurer.D060ClonedConjurer.BuildArena2()) { }

    private D060CulturedShabti(WorldState ws, Actor primary, (WPos center, ArenaBoundsCustom arena) a) : base(ws, primary, a.center, a.arena) { }

    private static (WPos center, ArenaBoundsCustom arena) BuildArena()
    {
        WPos[] vertices1 = [new(226.49f, 196.43f), new(238.31f, 203.26f), new(238.76f, 203.54f), new(239.63f, 204.05f), new(239.86f, 218.33f),
            ...
            new(226.02f, 236.68f), new(226f, 243.71f), new(216.15f, 249.4f), new(215.71f, 249.67f), new(213.5f, 250.94f),
            ...
            new(226.02f, 196.6f)];
        WPos[] vertices1h1 = [new(211.37f, 231.27f), new(211.85f, 231.42f), new(212.3f, 231.66f), new(213.35f, 231.72f), new(213.87f, 231.87f),
        ...
        WPos[] vertices1h2 = [new(226.96f, 206.41f), new(227.45f, 206.57f), new(229.4f, 207.38f), new(229.68f, 207.82f), new(229.75f, 208.33f),
        ...
        var arena = new ArenaBoundsCustom([new PolygonCustom(vertices1)], [new PolygonCustom(vertices1h1), new PolygonCustom(vertices1h2)]);
