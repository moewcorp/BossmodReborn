...
sealed class WallRemoval(BossModule module) : BossComponent(module)
{
    ...
    private static ArenaBoundsCustom GetArena1B() => new([D090MalboroTerra.GetVertices1(), D090MalboroTerra.GetVertices2(), D090MalboroTerra.GetVertices3()]);
    ...
    public override void DrawArenaBackground(int pcSlot, Actor pc)
    {
        ...
        if (isArena1B && pZ < 16f)
        {
            isArena1B = false;
            isArena2 = true;
            SetArena(new ArenaBoundsCustom([D090MalboroTerra.GetVertices2(), D090MalboroTerra.GetVertices3()]));
        }
        else if (isArena2 && pZ > 16f)
        {
            isArena2 = false;
            isArena1B = true;
            SetArena(GetArena1B());
...
[ModuleInfo(BossModuleInfo.Maturity.Verified, Contributors = "The Combat Reborn Team (Malediktus)", GroupType = BossModuleInfo.GroupType.CFC, GroupID = 41u, NameID = 4637u, SortOrder = 1)]
public sealed class D090MalboroTerra : BossModule
{
    public D090MalboroTerra(WorldState ws, Actor primary) : this(ws, primary, BuildArena())
    {
        ActivateComponent<WallRemoval>();
    }

    private D090MalboroTerra(WorldState ws, Actor primary, (WPos center, ArenaBoundsCustom arena) a) : base(ws, primary, a.center, a.arena) { }

    public static PolygonCustom GetVertices1()
    {
        return new PolygonCustom([new(118.79f, 15.9f), new(119.08f, 16.5f), new(119.06f, 17.86f), new(119.03f, 18.51f), new(118.63f, 21.23f),
    ...
    {
        return new PolygonCustom([new(101.95f, -22.44f), new(101.87f, -21.79f), new(101.81f, -21.12f), new(102.17f, -19.27f), new(102.31f, -18.65f),
    ...
    {
        return new PolygonCustom([new(80.68f, -76.27f), new(81.39f, -76.22f), new(82.03f, -76.09f), new(82.67f, -75.89f), new(83.27f, -75.63f),
