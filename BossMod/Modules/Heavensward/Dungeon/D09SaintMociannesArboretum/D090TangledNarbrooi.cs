...
{
    private static ArenaBoundsCustom GetArena1B() => new([D090TangledNarbrooi.GetVertices1(), D090TangledNarbrooi.GetVertices2()], D090TangledNarbrooi.GetHole());
    ...
    public override void DrawArenaBackground(int pcSlot, Actor pc)
    {
        ...
        {
            var pX = pos.X;
            if (isArena1B && pX > -101f)
            {
                SetArena(new([D090TangledNarbrooi.GetVertices2()], D090TangledNarbrooi.GetHole()));
                isArena1B = false;
                isArena2 = true;
            }
            else if (isArena2 && pX < -101f)
            {
                isArena2 = false;
                isArena1B = true;
                SetArena(GetArena1B());
...
public sealed class D090TangledNarbrooi : BossModule
{
    public D090TangledNarbrooi(WorldState ws, Actor primary) : this(ws, primary, BuildArena()) { }

    private D090TangledNarbrooi(WorldState ws, Actor primary, (WPos center, ArenaBoundsCustom arena) a) : base(ws, primary, a.center, a.arena) { }

    public static Polygon[] GetHole() => [new Polygon(new(-112.773f, 8.201f), 1.25f, 6)];
    public static PolygonCustom GetVertices1()
    {
        return new PolygonCustom([new(-124.78f, -10.09f), new(-123.51f, -8.38f), new(-123.01f, -8.12f), new(-122.39f, -7.85f), new(-121.80f, -7.73f),
    ...
    {
        return new PolygonCustom([new(-61.37f, -73.30f), new(-58.15f, -71.25f), new(-57.71f, -70.78f), new(-57.01f, -69.74f), new(-56.68f, -69.19f),
    ...
    {
        var arena = new ArenaBoundsCustom([GetVertices1()], GetHole());
