...
sealed class ReplayDetailsWindow : UIWindow
{
    ...
    public ReplayDetailsWindow(Replay data, RotationDatabase rotationDB, DateTime? initialTime) : base($"Replay: {data.Path}", false, Service.IsUIDev ? new(1200, 1500) : new(1500, 1000))
    {
        _player = new(data);
