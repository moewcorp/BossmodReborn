...
public sealed class ReplayParserLog : IDisposable
{
    ...
    private ClientState.OpActiveFateChange ParseClientActiveFate() => new(new(_input.ReadUInt(false), _input.ReadVec3(), _input.ReadFloat(), _version >= 28 ? _input.ReadByte(false) : default, _version >= 28 ? _input.ReadByte(false) : default));
