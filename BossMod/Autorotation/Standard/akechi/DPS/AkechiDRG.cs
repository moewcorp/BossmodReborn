...
public sealed class AkechiDRG(RotationModuleManager manager, Actor player) : AkechiTools<AID, TraitID>(manager, player)
{
    ...
    public static RotationModuleDefinition Definition()
    {
        ...
        res.Define(Track.LanceCharge).As<BuffsStrategy>("Lance Charge", "L. Charge", uiPriority: 170)
            ...
            .AddOption(BuffsStrategy.Force, "Force Lance Charge usage", 60, 20, ActionTargets.Self, 30)
            .AddOption(BuffsStrategy.ForceWeave, "Force Lance Charge usage inside the next possible weave window", 60, 20, ActionTargets.Self, 30)
            .AddOption(BuffsStrategy.Delay, "Delay Lance Charge usage", 0, 0, ActionTargets.None, 30)
        ...
        res.Define(Track.BattleLitany).As<BuffsStrategy>("BattleLitany", "B.Litany", uiPriority: 165)
            ...
            .AddOption(BuffsStrategy.Force, "Force Battle Litany usage", 180, 20, ActionTargets.Self, 52)
            .AddOption(BuffsStrategy.ForceWeave, "Force Battle Litany usage inside the next possible weave window", 180, 20, ActionTargets.Self, 52)
            .AddOption(BuffsStrategy.Delay, "Delay Battle Litany usage", 0, 0, ActionTargets.None, 52)
        ...
        res.Define(Track.LifeSurge).As<SurgeStrategy>("Life Surge", "L. Surge", uiPriority: 160)
            ...
            .AddOption(SurgeStrategy.WhenBuffed, "Attempts to use Life Surge when under any buffs - this may be wonky to use generally; mainly for rushing use when under raidbuff(s)", 40, 5, ActionTargets.Self, 6)
            .AddOption(SurgeStrategy.Force, "Force Life Surge usage", 40, 5, ActionTargets.Self, 6)
            .AddOption(SurgeStrategy.ForceWeave, "Force Life Surge usage inside the next possible weave window", 40, 5, ActionTargets.Self, 6)
            .AddOption(SurgeStrategy.ForceNextOpti, "Force Life Surge usage in next possible optimal window", 40, 5, ActionTargets.Self, 6)
            .AddOption(SurgeStrategy.ForceNextOptiWeave, "Force Life Surge optimally inside the next possible weave window", 40, 5, ActionTargets.Self, 6)
            .AddOption(SurgeStrategy.Delay, "Delay the use of Life Surge", 0, 0, ActionTargets.None, 6)
        ...
        res.Define(Track.TrueNorth).As<TrueNorthStrategy>("True North", "T.North", uiPriority: 95)
            ...
            .AddOption(TrueNorthStrategy.Rear, "Use True North for rear positional only", 45, 10, ActionTargets.Self, 50)
            .AddOption(TrueNorthStrategy.Flank, "Use True North for flank positional only", 45, 10, ActionTargets.Self, 50)
            .AddOption(TrueNorthStrategy.Force, "Force True North usage", 45, 10, ActionTargets.Self, 50)
            .AddOption(TrueNorthStrategy.Delay, "Delay True North usage", 0, 0, ActionTargets.None, 50)
        ...
        res.Define(Track.DragonfireDive).As<CommonStrategy>("Dragonfire Dive", "D.Dive", uiPriority: 155)
            ...
            .AddOption(CommonStrategy.Force, "Force Dragonfire Dive usage", 120, 0, ActionTargets.Hostile, 50, 91)
            .AddOption(CommonStrategy.ForceEX, "Force Dragonfire Dive (Grants Dragon's Flight)", 120, 30, ActionTargets.Hostile, 92)
            .AddOption(CommonStrategy.ForceWeave, "Force Dragonfire Dive usage inside the next possible weave window", 120, 0, ActionTargets.Hostile, 68)
            .AddOption(CommonStrategy.ForceWeaveEX, "Force Dragonfire Dive usage inside the next possible weave window (Grants Dragon's Flight)", 120, 30, ActionTargets.Hostile, 92)
            .AddOption(CommonStrategy.Delay, "Delay Dragonfire Dive usage", 0, 0, ActionTargets.None, 50)
        ...
        res.Define(Track.Geirskogul).As<CommonStrategy>("Geirskogul", "Geirs.", uiPriority: 150)
            ...
            .AddOption(CommonStrategy.Force, "Force Geirskogul usage", 60, 0, ActionTargets.Hostile, 60, 69)
            ...
            .AddOption(CommonStrategy.ForceWeave, "Force Geirskogul usage inside the next possible weave window", 60, 20, ActionTargets.Hostile, 70)
            .AddOption(CommonStrategy.ForceWeaveEX, "Force Geirskogul usage inside the next possible weave window (Grants Life of the Dragon & Nastrond Ready)", 60, 20, ActionTargets.Hostile, 70)
            .AddOption(CommonStrategy.Delay, "Delay Geirskogul usage", 0, 0, ActionTargets.None, 60)
        ...
        res.Define(Track.Stardiver).As<CommonStrategy>("Stardiver", "S.diver", uiPriority: 140)
            ...
            .AddOption(CommonStrategy.Force, "Force Stardiver usage", 30, 0, ActionTargets.Hostile, 80, 99)
            .AddOption(CommonStrategy.ForceEX, "Force Stardiver (Grants Starcross Ready)", 30, 0, ActionTargets.Hostile, 100)
            .AddOption(CommonStrategy.ForceWeave, "Force Stardiver usage inside the next possible weave window", 30, 0, ActionTargets.Hostile, 80)
            .AddOption(CommonStrategy.ForceWeaveEX, "Force Stardiver usage inside the next possible weave window (Grants Starcross Ready)", 30, 0, ActionTargets.Hostile, 100)
            .AddOption(CommonStrategy.Delay, "Delay Stardiver usage", 0, 0, ActionTargets.None, 80)
        ...
        res.Define(Track.Jump).As<CommonStrategy>("Jump", uiPriority: 145)
            ...
            .AddOption(CommonStrategy.Force, "Force Jump usage", 30, 0, ActionTargets.Hostile, 30, 67)
            .AddOption(CommonStrategy.ForceEX, "Force Jump usage (Grants Dive Ready buff)", 30, 15, ActionTargets.Hostile, 68)
            .AddOption(CommonStrategy.ForceWeave, "Force Jump usage inside the next possible weave window", 30, 0, ActionTargets.Hostile, 30, 67)
            .AddOption(CommonStrategy.ForceWeaveEX, "Force Jump usage inside the next possible weave window (Grants Dive Ready buff)", 30, 15, ActionTargets.Hostile, 68)
            .AddOption(CommonStrategy.Delay, "Delay Jump usage", 0, 0, ActionTargets.None, 30)
